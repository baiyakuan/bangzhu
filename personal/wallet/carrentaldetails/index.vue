<template>
	<div class="pd40-x pdb50">
		...
		<div class="orderInfoBox pd30-x">
			<div class="ft26 rgb27 pd50-y">租赁金额：</div>
			<div class="pdb50 fs border">
				...
				<div class="fcx" style="flex:1;justify-content: space-around;">
					<div class="fcy mgr50">
	...
	methods: {
		async getData() {
			...
			if (data.code === '1') {
				...
				that.orderInfo.deductMoney = ((data.obj.totalMoney -  data.obj.payMoney) * 1).toFixed(2);
			}
		}
	},
	onShow() {
