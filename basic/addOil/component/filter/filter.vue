<template>
    ...
    <view class="filter-wrapper" :style="{ height: height + 'rpx', top: top,'border-top':border?'1rpx solid #f2f2f2':'none' }" >
        <view class="inner-wrapper">
            <view class="mask" :class="showMask ? 'show' : 'hide'" @tap="tapMask" :style="{top:height+ 'rpx'}"></view>
            <view class="navs">
                <view class="c-flex-align" :class="{ 'c-flex-center': index >= 0, actNav: index === actNav }" v-for="(item, index) in navData" :key="index" @click="navClick(index)">
					...
					<image src="https://i.loli.net/2020/07/15/xjVSvzWcH9NO7al.png"  class="icon-triangle"></image>
                    <!-- <image src="https://i.loli.net/2020/07/15/QsHxlr1gbSImvWt.png"  class="icon-triangle" v-if="index === actNav"></image> -->
                    <!-- <image src="https://i.loli.net/2020/07/15/xjVSvzWcH9NO7al.png"  class="icon-triangle" v-else></image> -->
                </view>
...
export default {
    ...
    methods: {
        ...
        navClick(index) {
            ...
            this.showMask = true;
            this.actNav = index;
			this.$emit('onSelectedMask', this.showMask);
        },
        handleOpt(index) {
...
.filter-wrapper {
    ...
    .inner-wrapper {
        ...
        .navs {
            ...
            // border-bottom: 2rpx solid rgba(74,83,97,0.05);
            color: $main-gray;
            z-index: 999;
        ...
        .popup {
            ...
            .item-opt {
                ...
                padding: 0 80rpx;
                color: $main-gray;
                border-top: 2rpx solid rgba(74,83,97,0.05);
            }
            .actOpt {
                color: $main-gray;
                // font-weight: bold;
