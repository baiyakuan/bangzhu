			...
			<block>
				<view class="u-keyboard-grids-item" v-for="(group, i) in abc ? EngKeyBoardList : areaList" :key="i">
					<view
						...
						:key="j"
						:class="{ 'u-keyboard-grids-btn-disabled': item == 'I' || item == 'O' }"
					>
						{{ item }}
					</view>
				</view>
				...
				<view :hover-stay-time="100" class="u-keyboard-change" hover-class="u-carinput-hover" @tap="changeCarInputMode" v-if="showChangeLan">
