	...
	<u-popup closeable :maskCloseAble="maskCloseAble" mode="bottom" :popup="false" v-model="value" length="auto"
	 :safeAreaInsetBottom="safeAreaInsetBottom" @close="close" :z-index="uZIndex" :border-radius="borderRadius" :closeable="closeable">
		<view class="u-calendar">
			...
			<view class="u-calendar__action u-flex u-row-center" style="justify-content: space-around;">
				<view class="u-calendar__action__icon">
					<u-icon v-if="changeYear" name="arrow-left-double" :color="yearArrowColor" @click="changeYearHandler(0)"></u-icon>
				</view>
				<view class="u-calendar__action__icon" @click="changeMonthHandler(0)">
					<!-- <u-icon v-if="changeMonth" name="arrow-left" :color="monthArrowColor" @click="changeMonthHandler(0)"></u-icon> -->
					<image v-if="changeMonth" :src="staticImg + 'static/img/redArrowLeft.png'" style="width: 18rpx;height: 20rpx;"></image>
				</view>
				<view class="u-calendar__action__text">{{ showTitle }}</view>
				<view class="u-calendar__action__icon" @click="changeMonthHandler(1)">
					<!-- <u-icon v-if="changeMonth" name="arrow-right" :color="monthArrowColor" @click="changeMonthHandler(1)"></u-icon> -->
					<image v-if="changeMonth" :src="staticImg + 'static/img/redArrowRight.png'" style="width: 18rpx;height: 20rpx;"></image>
				</view>
				<view class="u-calendar__action__icon">
			...
			<view class="u-calendar__bottom">
				<view class="u-calendar__bottom__line"></view>
				<view class="u-calendar__bottom__complete" @click="btnFix(false)">
					完成
				</view>
...
<script>
	const monthMap = ['一', '二', '三', '四', '五', '六', '七', '八', '九', '十', '十一', '十二']
	export default {
		name: 'u-calendar',
		props: {
			safeAreaInsetBottom: {
		...
		methods: {
			...
			changeData() {
				...
				this.showTitle = `${monthMap[this.month-1]}月 ${this.year}`;
