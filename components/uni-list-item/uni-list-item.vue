		 ...
		 class="uni-list-item" @click="onClick">
			<view class="uni-list-item__container" :class="{'uni-list-item--first':isFirstChild}">
				...
				<view class="uni-list-item__content">
					<slot />
					<text class="uni-list-item__content-title" :class="{'ftweight':isBold}">{{ title }}</text>
				...
				<view class="uni-list-item__extra">
					...
					<uni-icons v-if="showArrow" :size="24" class="uni-icon-wrapper" color="#777777" type="arrowright" />
				</view>
			</view>
		</view>
		<!-- #ifdef APP-NVUE -->
